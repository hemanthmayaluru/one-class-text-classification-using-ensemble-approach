...
if __name__ == "__main__":
    ...
    print('Loading data...')
    train_data = webkb_train_dataset()
    test_data = webkb_test_dataset()
    
    # Converting the train and test data into dataframe
    train_data_df = train_data[:1500]
    val_data_df = train_data[1500:]
    test_data_df = test_data
    
    
    group_list = ['student', 'faculty', 'course', 'project']
    ...
    for embedding in embedding_list:
        ...
        for group in group_list:
            ...
            final_val = final_val[pd.notnull(final_val['text'])]
            ...
            # Converting the train and test data into dataframe
            train_data_df = webkb_train_dataset()[:1500]
            val_data_df = webkb_train_dataset()[1500:]
    ...
    filename = '/opt/notebooks/OCSVM_ISF_LOF_USE_Baselines/results_output_new/exp_ensemble_webkb.txt'
